    ...
    <table id="tabel-input">
        <tr>
            ...
            <td class="isian-formulir">
                <img src="images/cowok.jpg <?php echo $foto; ?>" width=70px height=75px>
        ...
        <tr>
            ...
            <td class="isian-formulir"><input type="text" name="idanggota"
        ...
        <tr>
            ...
            if ($r_tampil_anggota["jeniskelamin"] == "Pria") {
                echo "<td class=\"isian-formulir\"><input type=\"radio\" name=\"jenis_kelamin\" value=\"Pria\" checked>Pria</td></tr>
                <tr>
                ...
                echo "<td class=\"isian-formulir\"><input type=\"radio\" name=\"jenis_kelamin\" value=\"Pria\">Pria</td></tr>
                <tr>
                <td class=\"label-formulir\"></td>
