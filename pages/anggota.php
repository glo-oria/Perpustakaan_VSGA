...
<tr>
    ...
    <td><img src='images/cewek1.jpg'<?php echo $foto; ?> width=70px height=70px></td>
    ...
    <td>
        ...
        <div class="tombol-opai-container">
            <a href="proses/anggota-hapus.php?id=<?php echo $r_tampil_anggota['idanggota']; ?>"
                onclick="return_confirmation('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a>
        </div>
    </td>
</tr>
<?php $nomor++;
